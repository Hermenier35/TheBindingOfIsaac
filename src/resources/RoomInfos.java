...
public class RoomInfos
{
	...
	public static final Vector2 POSITION_DOOR_UP = Room.positionFromTileIndex(4, 8);
	public static final Vector2 POSITION_DOOR_DOWN = Room.positionFromTileIndex(4, 0);
	public static final Vector2 POSITION_DOOR_LEFT = Room.positionFromTileIndex(0, 4);
	public static final Vector2 POSITION_DOOR_RIGHT = Room.positionFromTileIndex(8, 4);
}
